...
import {
  ...
  SiNodedotjs, SiTypescript, SiNextdotjs, SiTailwindcss,
  SiPostgresql, SiSupabase, SiPrisma, SiSolidity,
...
const skillCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "TypeScript", desc: "Type-safe enterprise logic.", icon: <SiTypescript size={22} /> },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "PostgreSQL", desc: "Relational data management.", icon: <SiPostgresql size={22} /> },
      { name: "Prisma", desc: "Type-safe database ORM.", icon: <SiPrisma size={22} /> },
...
export default function Skills() {
  return (
    <main className="min-h-screen bg-[#070707] text-[#D1D1D1] font-serif pt-32 md:pt-48 pb-20 overflow-x-hidden relative selection:bg-[#BC002D]">
      
      {/* SIDEBAR COORDINATES - Hidden on mobile */}
      <div className="fixed top-12 left-12 mix-blend-difference z-50 hidden md:block">
        <div className="text-[9px] tracking-[1em] font-sans opacity-40 uppercase [writing-mode:vertical-rl] h-40 flex justify-between border-r border-white/10 pb-4">
          <span>2026</span>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-24">
        ...
        <div className="mb-24 md:mb-32">
          ...
          <h1 className="text-5xl md:text-[9rem] font-light tracking-tighter text-white leading-[0.9] md:leading-[0.85]">
          ...
          <div className="mt-12 md:mt-16 flex flex-col md:flex-row gap-10 items-start">
             <p className="max-w-md text-[9px] md:text-[10px] text-white/40 leading-relaxed uppercase tracking-[0.2em] md:tracking-[0.3em] font-sans">
                A curated selection of tools optimized for high-performance interaction, type-safety, and motion-heavy user experiences.
             </p>
          </div>
        </div>
                ...
                {cat.items.map((skill, i) => (
                  ...
                  >
                    <div className="relative z-10">
                      <div className="text-white/20 mb-5 group-hover:text-[#BC002D] transition-all duration-500">
                         {skill.icon}
                      </div>
                      <h3 className="text-lg md:text-xl font-light text-white mb-2 tracking-tight group-hover:pl-2 transition-all duration-300">
                        {skill.name}
                      </h3>
                      <p className="text-[10px] md:text-[11px] text-white/30 uppercase tracking-[0.1em] font-sans leading-relaxed">
                        {skill.desc}
                      </p>
                    </div>
      ...
      {/* FOOTER */}
      <footer className="mt-40 md:mt-60 py-16 md:py-20 px-6 md:px-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0 opacity-30">
        ...
        <div className="flex gap-4 hidden md:flex">
          <div className="w-[1px] h-4 bg-white/20 rotate-12" />
          <div className="w-[1px] h-4 bg-white/20 rotate-12" />
        </div>
